...
#
#  $ bin/test -s cs.tgate -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src cs.tgate.testing.CS_TGATE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/cs/tgate/tests/robot/test_example.robot
#
