...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.isProductInstalled("cs.tgate"))

    def test_browserlayer(self):
        """Test that ICsTgateLayer is registered."""
        from cs.tgate.interfaces import ICsTgateLayer
        from plone.browserlayer import utils

        self.assertIn(ICsTgateLayer, utils.registered_layers())
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        self.assertFalse(self.installer.isProductInstalled("cs.tgate"))

    def test_browserlayer_removed(self):
        """Test that ICsTgateLayer is removed."""
        from cs.tgate.interfaces import ICsTgateLayer
        from plone.browserlayer import utils
        self.assertNotIn(ICsTgateLayer, utils.registered_layers())
